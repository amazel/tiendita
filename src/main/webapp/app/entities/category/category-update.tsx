    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tienditaNiceApp.category.home.createOrEditLabel">Create or edit a Category</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : categoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="categoryNameLabel" for="category-categoryName">
                    Category Name
                  </Label>
                  <AvField id="category-categoryName" type="text" name="categoryName" />
                </AvGroup>
